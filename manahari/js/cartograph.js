   ...
   map.setMaxBounds([[27.4899932, 84.6882358], [27.652183, 84.9155915]]);
    ...
    function osmTiles() {
        return L.tileLayer(config["basemap-servers"][0] + '/{z}/{x}/{y}.png', {
            attribution: 'Basemap data &copy; <a href="http://openstreetmap.org">OpenStreetMap</a> contributors | Developed by <a href="http://kathmandulivinglabs.org">Kathmandu Living Labs</a>'
        });
    }
